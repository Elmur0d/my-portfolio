...
const MOCK_DATA = {
    ...
    projects: [
        ...
        },
        {
            ...
            description: "A real-time chat application built using React and Firebase Firestore, featuring user authentication and public messaging rooms.",
            techStack: ["React", "Firebase", "Tailwind"], 
            liveLink: "#",
            githubLink: "https://github.com/Elmur0d/chat-app"
        },
    ]
};

const SectionRef = React.forwardRef(({ children, id, className = "" }, ref) => (
    <section id={id} ref={ref} className={`mb-20 md:mb-32 pt-16 -mt-16 ${className}`}>
        {children}
    </section>
));
