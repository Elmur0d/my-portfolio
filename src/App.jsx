...
const Icon = ({ name, className }) => {
    const icons = {
        GithubIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Github-fill SVG Icon</title><g fill="none"><g clip-path="url(#akarIconsGithubFill0)"><path fill="currentColor" fill-rule="evenodd" d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385c.6.105.825-.255.825-.57c0-.285-.015-1.23-.015-2.235c-3.015.555-3.795-.735-4.035-1.41c-.135-.345-.72-1.41-1.23-1.695c-.42-.225-1.02-.78-.015-.795c.945-.015 1.62.87 1.845 1.23c1.08 1.815 2.805 1.305 3.495.99c.105-.78.42-1.305.765-1.605c-2.67-.3-5.46-1.335-5.46-5.925c0-1.305.465-2.385 1.23-3.225c-.12-.3-.54-1.53.12-3.18c0 0 1.005-.315 3.3 1.23c.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23c.66 1.65.24 2.88.12 3.18c.765.84 1.23 1.905 1.23 3.225c0 4.605-2.805 5.625-5.475 5.925c.435.375.81 1.095.81 2.22c0 1.605-.015 2.895-.015 3.3c0 .315.225.69.825.57A12.02 12.02 0 0 0 24 12c0-6.63-5.37-12-12-12" clip-rule="evenodd"/></g><defs><clipPath id="akarIconsGithubFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g></svg>
        ),
        LinkedinIcon: ( 
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Linkedin-box-fill SVG Icon</title><path fill="currentColor" fill-rule="evenodd" d="M1 2.838A1.838 1.838 0 0 1 2.838 1H21.16A1.837 1.837 0 0 1 23 2.838V21.16A1.838 1.838 0 0 1 21.161 23H2.838A1.838 1.838 0 0 1 1 21.161zm8.708 6.55h2.979v1.496c.43-.86 1.53-1.634 3.183-1.634c3.169 0 3.92 1.713 3.92 4.856v5.822h-3.207v-5.106c0-1.79-.43-2.8-1.522-2.8c-1.515 0-2.145 1.089-2.145 2.8v5.106H9.708zm-5.5 10.403h3.208V9.25H4.208zM7.875 5.812a2.063 2.063 0 1 1-4.125 0a2.063 2.063 0 0 1 4.125 0" clip-rule="evenodd"/></svg>
        ),
        TelegramIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Telegram-fill SVG Icon</title><g fill="none"><g clip-path="url(#akarIconsTelegramFill0)"><path fill="currentColor" fill-rule="evenodd" d="M24 12c0 6.627-5.373 12-12 12S0 18.627 0 12S5.373 0 12 0s12 5.373 12 12M12.43 8.859c-1.167.485-3.5 1.49-6.998 3.014c-.568.226-.866.447-.893.663c-.046.366.412.51 1.034.705c.085.027.173.054.263.084c.613.199 1.437.432 1.865.441c.389.008.823-.152 1.302-.48c3.268-2.207 4.955-3.322 5.061-3.346c.075-.017.179-.039.249.024c.07.062.063.18.056.212c-.046.193-1.84 1.862-2.77 2.726c-.29.269-.495.46-.537.504c-.094.097-.19.19-.282.279c-.57.548-.996.96.024 1.632c.49.323.882.59 1.273.856c.427.291.853.581 1.405.943c.14.092.274.187.405.28c.497.355.944.673 1.496.623c.32-.03.652-.331.82-1.23c.397-2.126 1.179-6.73 1.36-8.628a2.111 2.111 0 0 0-.02-.472a.506.506 0 0 0-.172-.325c-.143-.117-.365-.142-.465-.14c-.451.008-1.143.249-4.476 1.635" clip-rule="evenodd"/></g><defs><clipPath id="akarIconsTelegramFill0"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></g></svg>
        ),
        EmailIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><title>Email SVG Icon</title><path fill="currentColor" d="M28 6H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2m-2.2 2L16 14.78L6.2 8ZM4 24V8.91l11.43 7.91a1 1 0 0 0 1.14 0L28 8.91V24Z"/></svg>
        ),
        ReactIcon: (
...
const MOCK_DATA = {
    ...
    about: [
        "Привет! Меня зовут Иван, и я разработчик с 5-летним опытом, специализирующийся на **React, TypeScript и современном JavaScript**. Моя страсть — превращать сложные макеты в чистые, производительные интерфейсы.",
        "Последние два года я активно работал с Next.js, Vercel и бессерверными функциями, создавая масштабируемые продукты. Я также имею опыт работы с базами данных, таких как PostgreSQL и MongoDB, что позволяет мне эффективно работать с полным циклом разработки.",
        "В свободное время я работаю над пет-проектами (см. ниже) и вношу свой вклад в open-source. Я всегда открыт для новых возможностей и готов решать сложные задачи!",
    ],
    socials: [
        {email: "doniyorovelmurod60@gmail.com"},
        {github: "https://github.com/Elmur0d"},
        {linkedin: ""},
        {telegram: "@elik0I"}
    ],
    projects: [
        {
            ...
            liveLink: "forms-app-rho.vercel.app", 
...
const SectionRef = React.forwardRef(({ children, id, className = "" }, ref) => (
    <section id={id} ref={ref} className={`mb-16 md:mb-24 pt-16 -mt-16 ${className}`}>
        {children}
    </section>
));
...
const AboutSection = React.forwardRef((props, ref) => (
    <SectionRef id="about" ref={ref}>
        {MOCK_DATA.about.map((paragraph, index) => (
            <p key={index} className="mb-4 text-gray-400 leading-relaxed text-base md:text-lg">
                {paragraph}
            </p>
        ))}
    </SectionRef>
...
const ProjectCard = ({ project }) => (
    <a
        ...
        className="group block p-4 md:p-6 rounded-lg transition duration-300 hover:bg-slate-800/50 hover:shadow-xl"
    >
        <div className="flex justify-between items-start mb-4">
            <h3 className="text-xl font-bold text-slate-200 group-hover:text-teal-400 transition-colors">
                {project.title}
            </h3>
            <div className="flex space-x-3 text-slate-400 group-hover:text-teal-400">
                {project.githubLink && (
        ...
        <div className="flex flex-wrap gap-2">
            {project.techStack.map((tech) => (
                <span
                    key={tech}
                    className="text-xs font-mono text-teal-400 bg-teal-400/10 px-3 py-1 rounded-full"
                >
                    {tech}
                </span>
            ))}
...
function App() {
    ...
    return (
        <div className="bg-slate-900 font-sans text-gray-100 min-h-screen">
                ...
                <div className="lg:flex lg:justify-between lg:gap-4">
                    ...
                    <main className="pt-24 lg:w-2/3 lg:py-24">
                        ...
                        <footer className="mt-12 py-10 text-center text-xs text-slate-500">
                             ...
                             <p>Источник вдохновения: Brittany Chiang.</p>
                        </footer>
                    </main>
                </div>
            </div>
